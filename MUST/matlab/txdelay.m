...
%   depth increases).
%   ---
%   NOTE #2: the sign of TILT
%   TILT (in radians) describes the tilt angle in the trigonometric
%   direction. It is positive from Z axis to X axis. The trigonometric
%   directions are from the (positive) X axis to Y (for the xOy plane),
%   from Y to Z (for yOz) and from Z to X (zOx).
%   ---
%
%   Example #1:
%   ----------
...
%   Example #2:
%   ----------
%   %-- Generate a plane wave with a convex transducer
...
%
%   -- Damien Garcia -- 2015/03, last update: 2024/05/28
%   website: <a
...
switch option
    ...
    case 'Circular Wave'
        ...
        %-- Origo
        [x0,z0] = angles2origo(x(end)-x(1),tilt,width);
        %--
