...
def return_pw_cuda_beamformer(cfg):
    ...
    def beamformer(matrix):
        ...
        # Aplicar beamforming
        grid_size_img = (cfg['nz']//16, cfg['nx']//16)
        pwi(grid_size_img, (16, 16), (matrix_filt_gpu, matrix_imag_gpu, img_gpu, img_imag_gpu, cohe_gpu,
...
if __name__ == '__main__':
    ...
    cfg = {'fs': 62.5, 'c1': 6.3, 'pitch': 0.5, 'n_elementos': 128, 'n_angles': angles.size, 'f1': 2., 'f2': 8.,
           'taps': 62, 'bfd': 10, 'x_step': 0.2, 'z_step': 0.2, 'x0_roi': -20., 'z0_roi': 1., 'nx': 208, 'nz': 208,
